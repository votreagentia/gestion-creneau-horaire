...
app.post("/suggest-slots", (req, res) => {
  ...
  if (!free_slots || !Array.isArray(free_slots) || free_slots.length === 0) {
    return res
      ...
      .json({
        message:
          "Invalid input, 'free_slots' is required and should contain an array of slots.",
      });
  }
...
app.post("/extend-slots", (req, res) => {
  ...
  if (!requested_datetime) {
    return res
      .status(400)
      .json({ message: "Invalid input, 'requested_datetime' is required." });
  }
  ...
  if (isNaN(requestedDate.getTime())) {
    return res
      ...
      .json({
        message:
          "Invalid input, 'requested_datetime' must be a valid ISO date without timezone.",
      });
  }
  // Étendre de +1 jour
...
app.post("/answer", (req, res) => {
  ...
  if (
    ...
    return res
      ...
      .json({
        message:
          "Invalid input, 'suggested_slots' is required and should contain an array of slots.",
      });
  }
